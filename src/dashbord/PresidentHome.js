...
import { FaDollarSign, FaShippingFast, FaBoxOpen, FaSyncAlt, FaLeaf } from 'react-icons/fa';
...
export default function PresidentHome() {
    ...
    useEffect(() => {
        ...
        if (userId) {
            axios.get(`http://localhost:3000/api/stats/user/${userId}`)
                .then((response) => {
                ...
                <div className="w-full flex justify-center mb-8 flex-col">
                                    ...
                                    <div key={index} className="flex-shrink-0 w-1/6">
                                        <div className="card primary-gradient">
                                            <div className="card-body text-center px-9 pb-4">
                                                ...
                                                <h4 className="mb-3 d-flex align-items-center justify-content-center gap-1">{stat.count}</h4>
                                                <a href="javascript:void(0)" className="btn btn-white fs-2 fw-semibold text-nowrap">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                                ...
                                <div className="flex-shrink-0 w-1/6">
                                    <div className="card success-gradient">
                                        <div className="card-body text-center px-9 pb-4">
                                            ...
                                            <h4 className="mb-3 d-flex align-items-center justify-content-center gap-1">{stats.totalRevenue}</h4>
                                            <a href="javascript:void(0)" className="btn btn-white fs-2 fw-semibold text-nowrap">View Details</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="w-full max-w-7xl mt-8 px-4 py-6 bg-white shadow-lg rounded-xl">
                        <div className="text-center mb-6">
                            <h3 className="text-2xl font-semibold text-gray-800">Sales Chart Overview</h3>
                        </div>
