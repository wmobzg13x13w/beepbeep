    ...
    <div className="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
      ...
      <main className="w-full max-w-4xl p-6 bg-white rounded-lg shadow mt-10 flex">
        ...
        <div className="w-1/2 pr-6">
          ...
          <p className="mt-2">Continue using your email and password</p>
          <form action="/login" method="POST" className="mt-4">
            ...
            <label htmlFor="password" className="block text-sm font-medium text-gray-700 mt-4">Mot de passe :</label>
            <input
              type="password"
              id="password"
              name="password"
            ...
            <a href="#" className="block text-sm text-blue-500 hover:underline text-right mt-2">
              Mot de passe oublié ?
            </a>
            ...
            <p className="mt-4 text-center">
              Having no account? <a href="/signup" className="text-blue-500 hover:underline">Create an account</a>
            </p>
          </form>
